...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <h5>It's going to be impressive work using Vue.js. Enjoy the other admin pages for now <i
                        class="fa fa-arrow-left"></i></h5>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-bar-chart-o fa-fw"></i> Users Devices
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-bar-chart-o fa-fw"></i> Page Visits
                    <div class="pull-right">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                Actions
                ...
                <div class="panel-body">
                    <div class="list-group">
                        <a href="#" class="list-group-item">
                            <i class="fa fa-envelope fa-fw"></i> Someone Contacted You
                                    <span class="pull-right text-muted small"><em>4 minutes ago</em>
                                    </span>
                        </a>
                        <a href="#" class="list-group-item">
                            <i class="fa fa-user fa-fw"></i> Someone Visited
                                    <span class="pull-right text-muted small"><em>12 minutes ago</em>
                                    </span>
                        </a>
                        <a href="#" class="list-group-item">
                            <i class="fa fa-gear fa-fw"></i> Someone Viewed the Admin Area
